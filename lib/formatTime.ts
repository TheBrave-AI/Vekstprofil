...
export function relativeTime(d: Date | string): string {
  ...
  return new Date(d).toLocaleDateString("nb-NO", { day: "numeric", month: "short", timeZone: TZ });
}

export function fullDate(d: Date | string): string {
  return new Date(d).toLocaleDateString("nb-NO", { day: "numeric", month: "short", year: "numeric", timeZone: TZ });
}

export function timeOnly(d: Date | string): string {
  return new Date(d).toLocaleTimeString("nb-NO", { hour: "2-digit", minute: "2-digit", timeZone: TZ });
}
